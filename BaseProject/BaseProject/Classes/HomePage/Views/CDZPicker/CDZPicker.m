...
//    }
    ...
    genderLabel.font = [UIFont systemFontOfSize:20.0];
...
- (UIView *)containerView{
    if (!_containerView) {
        ...
        _containerView.backgroundColor = RGBColor(245, 245, 245);
    }
...
- (UIButton *)confirmButton{
    if (!_confirmButton) {
        ...
        UIColor *color = self.builder.confirmTextColor ?: UIColorFromHex(0x028BF3);
...
- (UIButton *)cancelButton{
    if (!_cancelButton) {
        ...
        UIColor *color = self.builder.cancelTextColor ?: UIColorFromHex(0x028BF3);
